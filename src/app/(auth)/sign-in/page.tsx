                ...
                {step === 1 && (
                  <Card className="mx-auto w-full">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Please provide your personal details to create your
                        account
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <CustomInput
                          control={form.control}
                          name="ssn"
                          label="Social Security Number / EGN"
                      ...
                      <div className="space-y-2">
                        <div className="grid grid-cols-3 gap-4">
                          <CustomInput
                            ...
                            name="address1"
                            label="Address"
                            placeholder="Example: Röntgenstr. 9"
                          />
                          <CustomInput
                            control={form.control}
                            name="city"
                            label="City"
                            placeholder="Example: Frankfurt"
                          />
                          <CustomInput
                            control={form.control}
                            name="country"
                        ...
                        <div className="flex flex-col space-y-4">
                          <div className="flex items-start space-x-3 rounded-lg border p-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-sm text-muted-foreground">
                                Everyday banking with no minimum balance and
                          ...
                          <div className="flex items-start space-x-3 rounded-lg border p-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-sm text-muted-foreground">
                                Earn interest on your balance with our
