    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="text-xs font-normal text-center dark:text-white text-black mt-8 mb-4 flex justify-center w-full">
        <div className="md:w-[1000px] w-[350px]">
          <p>
            “CGM,” the CGM logo and the Octagon Symbol are trademarks of CGM
            Bank, N.A. CGM Bank, N.A. is a wholly-owned subsidiary of CGM Bank &
            Co.
          </p>
          <p>
            "CGM Private Client" is the brand name for a banking and investment
            product and service offering, requiring a CGM Private Client
            Checking℠ account.
          </p>
          <p>
          ...
          <p>
            CGM Wealth Management is a business of CGM Bank & Co., which offers
            investment products and services through CGM Securities LLC (CGMS),
            a registered broker-dealer and investment adviser, member FINRA and
            SIPC. Insurance products are made available through CGM Insurance
            Agency, Inc. (CIA), a licensed insurance agency, doing business as
            CGM Insurance Agency Services, Inc. in Florida. Certain custody and
            other services are provided by CGM Bank, N.A. (CGB). CGMS, CIA, and
            CGB are affiliated companies under the common control of CGM Bank &
